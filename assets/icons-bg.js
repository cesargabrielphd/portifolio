...
function applyIconsPattern(tag, selectorType, selectorValue) {
  let heroContainer;
  if (selectorType === 'id') {
    heroContainer = document.querySelector(`#${selectorValue}`);
  } else if (selectorType === 'class') {
    heroContainer = document.querySelector(`.${selectorValue}`);
  }

  let figureElement = heroContainer.querySelector(tag);
...
// Usar a função
applyIconsPattern('figure', 'class', 'image-hero-container');
